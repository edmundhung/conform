...
import {
	...
	useFormMetadata as useFormMetadataDefault,
	configureForms,
} from '../future';
...
const testCases: Array<{
	...
	useFormMetadata: typeof useFormMetadataDefault;
	FormProvider: typeof FormProviderDefault;
}> = [
	{
		name: 'default',
		useForm: useFormDefault,
		useFormMetadata: useFormMetadataDefault,
		FormProvider: FormProviderDefault,
	},
	{
		name: 'configureForms',
		useForm: configured.useForm,
		useFormMetadata: configured.useFormMetadata,
		FormProvider: configured.FormProvider,
	},
];

describe.each(testCases)(
	'future export: useFormMetadata - $name',
	({ useForm, useFormMetadata, FormProvider }) => {
		type Schema = {
			title: string;
			description: string;
		};
