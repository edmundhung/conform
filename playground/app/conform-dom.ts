...
const validateIntentHandler: FormIntentHandler<{
	type: 'validate';
	payload?: string;
} | null> = {
	isApplicable(intent) {
...
const resetIntentHandler: FormIntentHandler<{ type: 'reset' }> = {
	isApplicable(intent) {
...
const updateIntentHandler: FormIntentHandler<{
	type: 'update';
	payload: {
		name?: string;
		index?: number;
...
const listIntentHandler: FormIntentHandler<
	| {
			type: 'insert';
			payload: {
				name: string;
