...
import { MobileSearch, Search } from '~/services/search/components';
...
function createSectionStore(sections: any[]) {
...
const SectionStoreContext = createContext(createSectionStore([]));
