...
This Astro 7 project is based on the current [`create astro`](https://docs.astro.build/en/install-and-setup/) minimal template. It demonstrates how to integrate Conform with [Astro Actions](https://docs.astro.build/en/guides/actions/) and a hydrated React 19 island.
