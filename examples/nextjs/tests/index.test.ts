	...
	for (const { name, path } of [
		...
		test.describe(name, () => {
			...
			test('submit', async ({ page, browserName }) => {
				...
				await expect(form.username).toBeFocused();
				...
				// Skip submission assertion in Firefox due to a known issue
				// with async onValidate blocking form submission
